...
public class ChangeTexture : MonoBehaviour
{
    ...
    public void Foul()
    {
        if (foul == true)
        {
            crAnim.SetBool("Foul", true);
        }
        else
        {
            crAnim.SetBool("Foul", false);
        }
    }
    ...
    public void Flop()
    {
        if (flop == true)
        {
            crAnim.SetBool("Flop", true);
        }
        else
        {
            crAnim.SetBool("Flop", false);
        }
    }
    ...
    public void Pass()
    {
        if (pass == true)
        {
            messiAnim.SetBool("Pass", pass);
        }
        else
        {
            messiAnim.SetBool("Pass", false);
        }
    }
    ...
    public void SlideTackle()
    {
        if (slideTackle == true)
        {
            messiAnim.SetBool("Slide Tackle", slideTackle);
        }

        else
        {
            messiAnim.SetBool("Slide Tackle", false);
        }
    }
